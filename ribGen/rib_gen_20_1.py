...
#-----------------------------------------signalbegin-------------------------------------------------------------------
        ...
        self.pushButton_checkProject.clicked.connect(self.checkProject)
...
#-----------------------button_page2_A01------------------------------   
    def checkProject(self):
        mayaProj = cmds.workspace(q=True, rd=True) #check workspace
        
        setrmsproj = 'rman setvar RMSPROJ \"' + mayaProj.replace("scenes/","") + '\"'
        try:
            pass
            mel.eval(setrmsproj)
        except:
        ...
        self.plainTextEdit.setPlainText('currentProj: '+mayaProj+'\n' +'set RMSPROJ to: ' +mayaProj)
