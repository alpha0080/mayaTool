...
class mod_MainWindow(QtGui.QMainWindow, Ui_MainWindow):
    def __init__(self, parent= QtGui.QApplication.activeWindow()):
        ...
        # self.setWindowFlags(QtCore.Qt.Tool) pushButton_setAssFile lineEdit_pushButton_setAssOutPutFolder
    ...
    def modlineEdit_deadLineJobName(self):
        ...
        self.jobName = self.lineEdit_deadLineJobName.text()
        self.lineEdit_deadLineJobName.setText(self.jobName)
