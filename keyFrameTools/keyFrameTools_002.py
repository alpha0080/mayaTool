...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_makeOffsetFrame.setGeometry(QtCore.QRect(290, 400, 91, 23))
        ...
        self.lineEdit_offfsetStartFrame.setGeometry(QtCore.QRect(40, 400, 61, 20))
        ...
        self.lineEdit_modifyValue.setGeometry(QtCore.QRect(40, 730, 61, 20))
        ...
        self.checkBox_translateX.setGeometry(QtCore.QRect(50, 610, 81, 16))
        ...
        self.checkBox_translateY.setGeometry(QtCore.QRect(130, 610, 81, 16))
        ...
        self.checkBox_translateZ.setGeometry(QtCore.QRect(210, 610, 81, 16))
        self.checkBox_translateZ.setObjectName("checkBox_translateZ")
        self.checkBox_rotateX = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_rotateX.setGeometry(QtCore.QRect(50, 640, 81, 16))
        self.checkBox_rotateX.setObjectName("checkBox_rotateX")
        self.checkBox_rotateY = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_rotateY.setGeometry(QtCore.QRect(130, 640, 81, 16))
        self.checkBox_rotateY.setObjectName("checkBox_rotateY")
        self.checkBox_rotateZ = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_rotateZ.setGeometry(QtCore.QRect(210, 640, 81, 16))
        self.checkBox_rotateZ.setObjectName("checkBox_rotateZ")
        self.checkBox_scaleX = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_scaleX.setGeometry(QtCore.QRect(50, 670, 81, 16))
        self.checkBox_scaleX.setObjectName("checkBox_scaleX")
        self.checkBox_scaleZ = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_scaleZ.setGeometry(QtCore.QRect(210, 670, 81, 16))
        self.checkBox_scaleZ.setObjectName("checkBox_scaleZ")
        self.checkBox_scaleY = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_scaleY.setGeometry(QtCore.QRect(130, 670, 81, 16))
        self.checkBox_scaleY.setObjectName("checkBox_scaleY")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(20, 200, 411, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_sf_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_sf_7.setGeometry(QtCore.QRect(30, 220, 231, 16))
        self.label_sf_7.setObjectName("label_sf_7")
        self.checkBox_offsetKeyAddKeys = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_offsetKeyAddKeys.setGeometry(QtCore.QRect(120, 350, 73, 16))
        self.checkBox_offsetKeyAddKeys.setObjectName("checkBox_offsetKeyAddKeys")
        self.checkBox_offsetKeySetStep = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_offsetKeySetStep.setGeometry(QtCore.QRect(200, 350, 73, 16))
        self.checkBox_offsetKeySetStep.setObjectName("checkBox_offsetKeySetStep")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_sf_7.setText(QtWidgets.QApplication.translate("MainWindow", "Offset / Cutting / Align All Keys", None, -1))
        self.checkBox_offsetKeyAddKeys.setText(QtWidgets.QApplication.translate("MainWindow", "add keys", None, -1))
        self.checkBox_offsetKeySetStep.setText(QtWidgets.QApplication.translate("MainWindow", "set Step", None, -1))
    ...
    def offsetKeyFrames(self):
       ...
       # offsetValue = float(self.lineEdit_offsetFrame.text())
        ...
        for obj in objList:
            ...
            divideStepFrame = divideFrame-1+0.01
           ...
           # if 
            for attr in keyAbleAttList :
                ...
                try:
                   ...
                   # startFrameValue = cmds.keyframe(obj,at=attr,t=(offsetStartFrame,offsetStartFrame),q=True,eval=True)[0] # get startFrame value
                  #  endFraameValue = cmds.keyframe(obj,at=attr,t=(offsetEndFrame,offsetEndFrame),q=True,eval=True)[0] # get endFrame value
                  #  cmds.setKeyframe(obj, t=[startFrameValue,startFrameValue], at=attr,v=startFrameValue ) #setKey to startFrame
                   # cmds.setKeyframe(obj, t=[endFraameValue,endFraameValue], at=attr,v=endFraameValue ) #setKey to endFrame
                 #   cmds.setKeyframe(obj, t=[startFrameValue,startFrameValue], at=attr)
                  #  cmds.setKeyframe(obj, t=[endFraameValue,endFraameValue], at=attr)
