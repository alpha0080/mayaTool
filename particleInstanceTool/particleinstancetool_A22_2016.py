...
class mod_MainWindow(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def exportCacheFolderSelect(self):
        ...
        for i in range(0,jsonFilesCount):
            ...
            self.listWidget_fileList.item(i).setText(QtGui.QApplication.translate("MainWindow","tempName", None, -1))
    ...
    def clickButton_writeCache(self):
        if len(self.lineEdit_exportFolder.text()) == 0:
            ...
            if len(self.fileList) == 0:
                ...
                QtGui.QListWidgetItem(self.listWidget_fileList)
                self.listWidget_fileList.item(0).setText(QtGui.QApplication.translate("MainWindow","tempName", None, -1))
        ...
        for i in range(0,selectObjsCount):
          ...
          #      pass
           # else:
            ...
            self.listWidget_objList.item(itemCount).setText(QtGui.QApplication.translate("MainWindow","tempName", None, -1))
