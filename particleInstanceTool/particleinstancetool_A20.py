...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3.addPixmap(QtGui.QPixmap("icons/particleInstanceToolIcons/getParticlesB-512.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        self.pushButton_create.setGeometry(QtCore.QRect(380, 50, 50, 50))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(83, 89, 89))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_create.setIconSize(QtCore.QSize(50, 50))
