...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_createMode_2 = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_createMode_2.setText(QtWidgets.QApplication.translate("MainWindow", "Create from Particles", None, -1))
...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #def self.MODDEF(self):
        ...
        # do test 
        self.pushButton_getInfo.clicked.connect(self.clickButtin_createInstanceFromCache)
    ...
    def clickButton_getParticle(self):
       ...
       # icon = QtGui.QIcon()
        ...
        #icon.addPixmap(QtGui.QPixmap("icons/particleInstanceToolIcons/getParticlesA-512.png"))
   ...
   # def aaaaaa(self):
    ...
    def checkMode(self):
        if self.label_createMode.text() =='cache Mode':
