    ...
    def treeBuildTest(self):
       ...
       # index = 0
        ...
        for index in range(0,10):
            ...
            maxTopLayerItemCount = int(self.allAssetGrpDepthDict[self.allAssetGrpDepthDict.keys()[index]][0])
            delta= maxTopLayerItemCount - self.treeWidget.topLevelItemCount() 
            print 'delta',delta
            if delta >= 0:
          ...
          #  print self.treeWidget.topLevelItemCount()
            ...
            for i in range(0,rangeCount):
                ...
                print 'maxTopLayerItemCount',maxTopLayerItemCount
                if i == 0:           #create toplevelItem
                    

                        #if self.treeWidget.topLevelItemCount() < maxCurrentLevelCount :
