...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_selectProj.setGeometry(QtCore.QRect(246, 23, 292, 22))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_complete.setGeometry(QtCore.QRect(151, 20, 30, 30))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_fileData_38.setGeometry(QtCore.QRect(137, 0, 56, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_fileData_47.setGeometry(QtCore.QRect(239, 0, 116, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.lineEdit_currentFileName.setGeometry(QtCore.QRect(247, 313, 291, 30))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.frame_3.setGeometry(QtCore.QRect(0, 58, 40, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_all.setGeometry(QtCore.QRect(6, 20, 25, 25))
        self.pushButton_all.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/AllS5close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/AllS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_all.setIcon(icon8)
        ...
        self.label_fileData_10.setGeometry(QtCore.QRect(9, 0, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(8)
        ...
        self.frame.setGeometry(QtCore.QRect(247, 58, 331, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.treeWidget_branches.setGeometry(QtCore.QRect(247, 117, 387, 195))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.listWidget_assetProj.setGeometry(QtCore.QRect(0, 117, 245, 412))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.listWidget_assetProj.setAutoScrollMargin(16)
        self.listWidget_assetProj.setSpacing(0)
        ...
        self.plainTextEdit_BranchFileInfo.setGeometry(QtCore.QRect(247, 530, 387, 274))
        palette = QtGui.QPalette()
        ...
        self.tableWidget_FileList.setGeometry(QtCore.QRect(247, 344, 387, 185))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.frame_2.setGeometry(QtCore.QRect(40, 58, 160, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/otherS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/otherS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_others.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/vehS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon19.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/vehS5_open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_vehicle.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/chaS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon20.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/chaS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/setS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon21.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/setS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/propsS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon22.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/propsS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_props.setIcon(icon22)
        ...
        self.pushButton_createNewBranch.setGeometry(QtCore.QRect(540, 122, 25, 25))
        self.pushButton_createNewBranch.setText("")
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_createNewBranch.setIcon(icon23)
        self.pushButton_createNewBranch.setIconSize(QtCore.QSize(25, 25))
        ...
        self.pushButton_deleteBranch = QtWidgets.QPushButton(self.tab_branch)
        self.pushButton_deleteBranch.setEnabled(True)
        self.pushButton_deleteBranch.setGeometry(QtCore.QRect(572, 122, 25, 25))
        self.pushButton_deleteBranch.setText("")
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/subC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon24.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/subC2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_deleteBranch.setIcon(icon24)
        self.pushButton_deleteBranch.setIconSize(QtCore.QSize(25, 25))
        self.pushButton_deleteBranch.setCheckable(True)
        self.pushButton_deleteBranch.setAutoRepeat(False)
        self.pushButton_deleteBranch.setAutoExclusive(False)
        self.pushButton_deleteBranch.setAutoRepeatDelay(5)
        self.pushButton_deleteBranch.setAutoDefault(False)
        self.pushButton_deleteBranch.setDefault(False)
        self.pushButton_deleteBranch.setFlat(True)
        self.pushButton_deleteBranch.setObjectName("pushButton_deleteBranch")
        self.frame_7 = QtWidgets.QFrame(self.tab_branch)
        self.frame_7.setGeometry(QtCore.QRect(0, 530, 246, 274))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.frame_24.setGeometry(QtCore.QRect(580, 58, 55, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/gotoA.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_gotoPublishFolder.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C4.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C4.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512D2.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_gotPublish.setIcon(icon26)
        ...
        self.pushButton_openBranchJson.setGeometry(QtCore.QRect(604, 122, 25, 25))
        self.pushButton_openBranchJson.setText("")
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/openFolder_E1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon27.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/openFolder_E2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_openBranchJson.setIcon(icon27)
        self.pushButton_openBranchJson.setIconSize(QtCore.QSize(25, 25))
        self.pushButton_openBranchJson.setCheckable(True)
        self.pushButton_openBranchJson.setAutoRepeat(False)
        self.pushButton_openBranchJson.setAutoExclusive(False)
        self.pushButton_openBranchJson.setAutoRepeatDelay(5)
        ...
        self.pushButton_saveFile.setGeometry(QtCore.QRect(540, 313, 30, 30))
        self.pushButton_saveFile.setText("")
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon28.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon28.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        self.pushButton_loadFile.setGeometry(QtCore.QRect(572, 313, 30, 30))
        self.pushButton_loadFile.setText("")
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon29.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon29.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_loadFile.setIcon(icon29)
        ...
        self.pushButton_uploadPublish = QtWidgets.QPushButton(self.tab_branch)
        self.pushButton_uploadPublish.setEnabled(True)
        self.pushButton_uploadPublish.setGeometry(QtCore.QRect(604, 313, 30, 30))
        self.pushButton_uploadPublish.setText("")
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_uploadPublish.setIcon(icon30)
        self.pushButton_uploadPublish.setIconSize(QtCore.QSize(30, 30))
        ...
        self.pushButton_editFileInfo.setGeometry(QtCore.QRect(570, 533, 30, 30))
        self.pushButton_editFileInfo.setText("")
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/edit_E1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon31.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/edit_E2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_editFileInfo.setIcon(icon31)
        ...
        self.pushButton_openFolder.setGeometry(QtCore.QRect(602, 533, 30, 30))
        self.pushButton_openFolder.setText("")
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/detial_E1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon32.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/detial_E2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_openFolder.setIcon(icon32)
        ...
        self.frame_4.setGeometry(QtCore.QRect(200, 58, 46, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/shotS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/shotS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_shot.setIcon(icon33)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plainTextEdit_BranchFileInfo.setPlainText(QtWidgets.QApplication.translate("MainWindow", "info:", None, -1))
...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def publishToGlobal(self):
        ...
        pubishTag = self.publishToolSettingData['globalPublishRoot'] +'/' + self.assetName
...
######-------------------------------store userPref End-------------------------------------------------------------------        
   ...
   # def buildInfoTreeFromTactic(self):
    ...
    def createFileTable(self):
        ...
        try:                   
            ...
            if len(tableIndex) > 0:
            #    print "createFileTable check point 01_1"
             ...
             #   print "createFileTable check point 01_2"
    ...
    def openSelectFile(self):
        ...
        self.plainTextEdit_BranchFileInfo.clear()
        text = 'open select file %s'%fullFileName
        self.plainTextEdit_BranchFileInfo.setPlainText(text)
        cmds.file( fullFileName, open=True,f=True,iv=True ) #open file
        
        cmds.workspace(self.workProject, o=True) #set project
        

        self.pushButton_loadFile.setChecked(0)
    ...
    def getSavingFile(self):
      ...
      #                  print existVerNum
        ...
        self.plainTextEdit_BranchFileInfo.clear()
        text = 'save file %s'%self.longSavingName
        self.plainTextEdit_BranchFileInfo.setPlainText(text)
        ...
        self.pushButton_saveFile.setChecked(0)
 ...
 #-----------------print out file info in textBrowser function End-------------------------------------------------------------------     
     ...
     #   print 'run findParentTopLevelItem start'
        ...
        #finding 2nd level item topLevelItemIndex and childIndex ,     topLevelItem(topLevelItemIndex).child(secLevelItemIndex)
           ...
           # print "2nd level item"
            ...
            secLevelItemIndex = self.secLayerItemDict[selectItem]   #self.secLayerItemDict  資訊不對
    ...
    def delSelectBranch(self):
        #print self.treeWidget_branches.currentItem()
        self.plainTextEdit_BranchFileInfo.clear()  #clear info box
        getDelItem = self.treeWidget_branches.currentItem()
        #print str(getDelItem), type(getDelItem)
        backupRootFolder= self.workProject+'/'+'scenes'+'/' +'.backup'
        
        print 'backupRootFolder',backupRootFolder
            
        try:
            
            os.mkdir(backupRootFolder)
           # self.plainTextEdit_BranchFileInfo.clear()
           # text = 'create backup folder %s'%self.backupRootFolder
           # self.plainTextEdit_BranchFileInfo.setPlainText(text)
            pass
        except:
            pass
        ...
        if str(getDelItem) == 'None':
                    
            self.plainTextEdit_BranchFileInfo.clear()
            #text = 'save file %s'%self.longSavingName
            self.plainTextEdit_BranchFileInfo.setPlainText('no item selected')
            pass
            
        else:
            if self.treeWidget_branches.isItemSelected(getDelItem) == True:
              #  print 'aaaaa'
                self.checkTreeWidgetBranchesDepth(getDelItem)
                fullNameList = []
                deleteDirTempList = []
                deleteRootFolder =  self.workProject+'/'+'scenes' 

                itemName = getDelItem.text(0)
            
                print 'itemName',itemName
                for i in range(0,self.depthLevel):
                    print i
                    fullNameList.append(getDelItem.parent().text(0)) 
                    getDelItem = getDelItem.parent()
                ...
                if self.treeWidget_branches.indexOfTopLevelItem(self.treeWidget_branches.currentItem())==-1:    
                    ...
                    for i in range(0,len(fullNameList)):
                        #print list(reversed(fullNameList))[i]
                        createFolder = backupRootFolder +'/'+list(reversed(fullNameList))[i]
                        deleteRootFolder = deleteRootFolder +'/'+list(reversed(fullNameList))[i]
                        deleteDirTempList.append(deleteRootFolder)
                        try:
                            print 'make folder %s'%createFolder
                            os.mkdir(createFolder)
                        except:
                            pass

                        backupRootFolder = backupRootFolder +'/'+list(reversed(fullNameList))[i]
                    #deleteDirList = list(reversed(deleteDirTempList))#.append(deleteRootFolder+'/'+ itemName)
                    
                    deleteDirTempList.append(deleteRootFolder+'/'+ itemName)
                else:
                    selectItemFullName = self.workProject+'/'+'scenes'+'/'+ itemName
                    deleteDirTempList.append(deleteRootFolder+'/'+ itemName)

                backupFolder = backupRootFolder +'/'+ itemName
        ...
        print 'deleteDirList',deleteDirTempList

        


        self.moveSelectFolderToBackupFolder(selectItemFullName,backupFolder,'move',deleteDirTempList)
        self.getExistBranchDict()
        self.buildExistFileInfoTree()
        self.buildTreeFromExistFileData()	
        self.tableWidget_FileList.clear()
        ...
        self.pushButton_deleteBranch.setChecked(0)
        


    def moveSelectFolderToBackupFolder(self,root_src_dir,root_target_dir,operation,deleteDirTempList):

        reverseDeleteDirTempList = list(reversed(deleteDirTempList))
      #  print 'reverseDeleteDirTempList',reverseDeleteDirTempList
       # root_src_dir = '//mcd-one/3d_project/python_study/assets/other/tree_depth_test/concept/scenes/una'

       # root_target_dir = '//mcd-one/3d_project/python_study/assets/other/tree_depth_test/concept/scenes/aaaaa'
              ...
              #  print 'src_file' ,src_file
               # print dst_file
                ...
                if operation is 'copy':
                   ...
                   # print 'mmm',list(reversed(deleteDirTempList))
        if operation is 'move':
            for i in reverseDeleteDirTempList:
                try:
                    os.rmdir(i)
                except:
                    pass
    ...
    def getExistBranchDict(self):
      ...
      #  print "run getExistBranchDict start"
       ...
       # self.branchDict={"0":{"master":{}}}
        ...
        print 'secLayerItemDict2222',self.secLayerItemDict
    ...
    def openFolder(self):
        ...
        self.pushButton_openBranchJson.setChecked(0)
