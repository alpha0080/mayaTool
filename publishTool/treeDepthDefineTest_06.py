...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def treeBuildPreItem(self,itemDictKeyIndex):
        ...
        topLayerItemCountCurrent = self.treeWidget.topLevelItemCount()
        print 'topLayerItemCountCurrent',topLayerItemCountCurrent
        topLayerItemIndexOfDict = int(self.allAssetGrpDepthDict[self.allAssetGrpDepthDict.keys()[itemDictKeyIndex]][0])
        print 'topLayerItemIndexOfDict',topLayerItemIndexOfDict
        delta =  topLayerItemIndexOfDict - topLayerItemCountCurrent
        print 'delta',delta
        if delta > 0:
      ...
      #  print 'topLayerItem',topLayerItem
        ...
        for i in range(1,rangeCount):
            topLayerItem = self.treeWidget.topLevelItem(topLayerItemIndexOfDict)
            ...
            #    print 'maxCurrentLevelCount',maxCurrentLevelCount
                for j in range(0,maxCurrentLevelCount):
                  #  if topLayerItemCountCurrent < maxCurrentLevelCount:
                       # delta = topLayerItemCountCurrent
                    topLayerItem = QtWidgets.QTreeWidgetItem(self.treeWidget)
            '''
