...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget_branch.setGeometry(QtCore.QRect(5, 17, 641, 946))
        ...
        self.tabWidget_branch.setProperty("tabBarAutoHide", False)
        ...
        self.comboBox_selectProj.setGeometry(QtCore.QRect(226, 23, 271, 22))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_complete.setGeometry(QtCore.QRect(180, 20, 30, 30))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_buildFolder.setGeometry(QtCore.QRect(540, 20, 31, 31))
        self.pushButton_buildFolder.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/masterB2-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_buildFolder.setIcon(icon3)
        ...
        self.label_fileData_29.setGeometry(QtCore.QRect(540, 0, 30, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_fileData_38.setGeometry(QtCore.QRect(165, 0, 56, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_fileData_47.setGeometry(QtCore.QRect(221, 0, 116, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/connerA.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_changePageA.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/connerB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_changePageB.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/connerC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_changePageC.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/connerD.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_changePageD.setIcon(icon7)
        ...
        self.lineEdit_currentFileName.setGeometry(QtCore.QRect(225, 313, 353, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.frame_9 = QtWidgets.QFrame(self.tab_branch)
        self.frame_9.setGeometry(QtCore.QRect(581, 117, 51, 409))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_openBranchJson.setGeometry(QtCore.QRect(7, 20, 35, 35))
        self.pushButton_openBranchJson.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/option2-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_openBranchJson.setIcon(icon8)
        self.pushButton_openBranchJson.setIconSize(QtCore.QSize(35, 35))
        ...
        self.label_fileData_30.setGeometry(QtCore.QRect(8, 6, 31, 16))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_loadFile.setGeometry(QtCore.QRect(7, 265, 35, 35))
        self.pushButton_loadFile.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon9.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon9.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/load_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_loadFile.setIcon(icon9)
        self.pushButton_loadFile.setIconSize(QtCore.QSize(35, 35))
        ...
        self.pushButton_saveFile.setGeometry(QtCore.QRect(7, 205, 35, 35))
        self.pushButton_saveFile.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon10.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/save_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_saveFile.setIcon(icon10)
        self.pushButton_saveFile.setIconSize(QtCore.QSize(35, 35))
        ...
        self.label_fileData_32.setGeometry(QtCore.QRect(7, 252, 31, 16))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_fileData_31.setGeometry(QtCore.QRect(7, 192, 31, 16))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_uploadPublish = QtWidgets.QPushButton(self.frame_9)
        self.pushButton_uploadPublish.setEnabled(True)
        self.pushButton_uploadPublish.setGeometry(QtCore.QRect(7, 330, 35, 35))
        self.pushButton_uploadPublish.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon11.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon11.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/publish_e2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_uploadPublish.setIcon(icon11)
        self.pushButton_uploadPublish.setIconSize(QtCore.QSize(35, 35))
        ...
        self.label_fileData_34 = QtWidgets.QLabel(self.frame_9)
        self.label_fileData_34.setGeometry(QtCore.QRect(7, 317, 31, 16))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(248, 255, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.frame_3 = QtWidgets.QFrame(self.tab_branch)
        self.frame_3.setGeometry(QtCore.QRect(0, 60, 46, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/AllS5close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon12.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/AllS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_all.setIcon(icon12)
        ...
        self.frame = QtWidgets.QFrame(self.tab_branch)
        self.frame.setGeometry(QtCore.QRect(225, 60, 353, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/simulation_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon13.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/simulation_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processSimulation.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/animation_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon14.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/animation_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processAnimation.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/effect_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon15.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/effect_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processEffects.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/lighting_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon16.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/lighting_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processLighting.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/layout_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon17.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/layout_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processLayout.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/rigging_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/rigging_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processRigging.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/texture_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon19.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/texture_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_processTexture.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/concept_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon20.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/concept3_open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/modeling_3Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon21.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/modeling_3Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        self.frame_10 = QtWidgets.QFrame(self.tab_branch)
        self.frame_10.setGeometry(QtCore.QRect(581, 530, 51, 261))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/view-details-60.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_openFolder.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/pencil_and_paper-60.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_editFileInfo.setIcon(icon23)
        ...
        self.treeWidget_branches.setGeometry(QtCore.QRect(225, 117, 353, 195))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        brush = QtGui.QBrush(QtGui.QColor(128, 182, 135))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.ButtonText, brush)
        brush = QtGui.QBrush(QtGui.QColor(24, 36, 23))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.frame_4 = QtWidgets.QFrame(self.tab_branch)
        self.frame_4.setGeometry(QtCore.QRect(0, 120, 46, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/shotS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon24.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/shotS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_shot.setIcon(icon24)
        ...
        self.listWidget_assetProj.setGeometry(QtCore.QRect(50, 116, 171, 411))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.plainTextEdit_BranchFileInfo.setGeometry(QtCore.QRect(225, 530, 353, 260))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(221, 253, 230))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        brush = QtGui.QBrush(QtGui.QColor(14, 21, 19))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.frame_13 = QtWidgets.QFrame(self.tab_branch)
        self.frame_13.setGeometry(QtCore.QRect(0, 180, 46, 347))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.tableWidget_FileList.setGeometry(QtCore.QRect(225, 345, 353, 181))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.frame_2 = QtWidgets.QFrame(self.tab_branch)
        self.frame_2.setGeometry(QtCore.QRect(50, 60, 171, 56))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/otherS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon25.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/otherS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_others.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/vehS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/vehS5_open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_vehicle.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/chaS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon27.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/chaS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_character.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/setS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon28.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/setS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_set.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/propsS5Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon29.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/propsS5Open.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_props.setIcon(icon29)
        ...
        self.pushButton_createNewBranch.setGeometry(QtCore.QRect(536, 120, 20, 20))
        self.pushButton_createNewBranch.setText("")
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon30.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/addC2.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_createNewBranch.setIcon(icon30)
        self.pushButton_createNewBranch.setIconSize(QtCore.QSize(20, 20))
        self.pushButton_createNewBranch.setCheckable(True)
        self.pushButton_createNewBranch.setAutoRepeat(False)
        self.pushButton_createNewBranch.setAutoExclusive(False)
        self.pushButton_createNewBranch.setAutoRepeatDelay(5)
        ...
        self.pushButton_createNewBranch_2 = QtWidgets.QPushButton(self.tab_branch)
        self.pushButton_createNewBranch_2.setEnabled(True)
        self.pushButton_createNewBranch_2.setGeometry(QtCore.QRect(557, 120, 20, 20))
        self.pushButton_createNewBranch_2.setText("")
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/subC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon31.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/subC2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_createNewBranch_2.setIcon(icon31)
        self.pushButton_createNewBranch_2.setIconSize(QtCore.QSize(20, 20))
        self.pushButton_createNewBranch_2.setCheckable(True)
        self.pushButton_createNewBranch_2.setAutoRepeat(False)
        self.pushButton_createNewBranch_2.setAutoExclusive(False)
        self.pushButton_createNewBranch_2.setAutoRepeatDelay(5)
        self.pushButton_createNewBranch_2.setAutoDefault(False)
        self.pushButton_createNewBranch_2.setDefault(False)
        self.pushButton_createNewBranch_2.setFlat(True)
        self.pushButton_createNewBranch_2.setObjectName("pushButton_createNewBranch_2")
        self.frame_7 = QtWidgets.QFrame(self.tab_branch)
        self.frame_7.setGeometry(QtCore.QRect(0, 530, 221, 261))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.frame_24 = QtWidgets.QFrame(self.tab_branch)
        self.frame_24.setGeometry(QtCore.QRect(580, 60, 50, 55))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.pushButton_gotoPublishFolder.setGeometry(QtCore.QRect(6, 1, 36, 15))
        self.pushButton_gotoPublishFolder.setText("")
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/gotoA.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_gotoPublishFolder.setIcon(icon32)
        ...
        self.pushButton_gotPublish = QtWidgets.QPushButton(self.frame_24)
        self.pushButton_gotPublish.setEnabled(False)
        self.pushButton_gotPublish.setGeometry(QtCore.QRect(8, 17, 35, 35))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C4.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C4.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512D2.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon33.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C3.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_gotPublish.setIcon(icon33)
        self.pushButton_gotPublish.setIconSize(QtCore.QSize(35, 35))
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/PNG-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_convertToPng.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/jpgs-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_convertToJpg.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/TEX-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_convertToTex.setIcon(icon36)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/EXR-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_convertToExr.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/replaceRoot.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_replaceFileRoot.setIcon(icon38)
        ...
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/getSelectItemPublishB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_getSelectedNode.setIcon(icon39)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/refreshPublishB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_refreshList.setIcon(icon40)
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/reNameB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_reName.setIcon(icon41)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/unCheckB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_unCheckAll.setIcon(icon42)
        ...
        icon43 = QtGui.QIcon()
        icon43.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/deletePublishB.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_delectSelectItems.setIcon(icon43)
        ...
        icon44 = QtGui.QIcon()
        icon44.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/uploadPublishC_60.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_publishAll.setIcon(icon44)
        ...
        icon45 = QtGui.QIcon()
        icon45.addPixmap(QtGui.QPixmap("//mcd-one/database/assets/scripts/maya_scripts/icons/publishToolIcon/Live_Sync_D60.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_uploadSyncA.setIcon(icon45)
        ...
        self.pushButton_changePageA_2.setIcon(icon4)
        ...
        self.pushButton_changePageB_2.setIcon(icon5)
        ...
        self.pushButton_changePageC_2.setIcon(icon6)
        ...
        self.pushButton_changePageD_2.setIcon(icon7)
        ...
        self.frame_19.setGeometry(QtCore.QRect(5, 20, 426, 241))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(185, 198, 185))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_optionPage_tempB_3 = QtWidgets.QLabel(self.frame_19)
        self.label_optionPage_tempB_3.setGeometry(QtCore.QRect(10, 45, 51, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_optionPage_tempB_3.setFont(font)
        self.label_optionPage_tempB_3.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.label_optionPage_tempB_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_optionPage_tempB_3.setObjectName("label_optionPage_tempB_3")
        self.lineEdit_setRoot_2 = QtWidgets.QLineEdit(self.frame_19)
        self.lineEdit_setRoot_2.setGeometry(QtCore.QRect(70, 40, 321, 26))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.lineEdit_setRoot_2.setPalette(palette)
        self.lineEdit_setRoot_2.setObjectName("lineEdit_setRoot_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_fileData_34.setText(QtWidgets.QApplication.translate("MainWindow", "Load", None, -1))
        ...
        self.treeWidget_branches.topLevelItem(0).child(0).setText(0, QtWidgets.QApplication.translate("MainWindow", "sss", None, -1))
        self.treeWidget_branches.topLevelItem(0).child(0).child(0).setText(0, QtWidgets.QApplication.translate("MainWindow", "dsdsd", None, -1))
        self.treeWidget_branches.topLevelItem(0).child(0).child(0).child(0).setText(0, QtWidgets.QApplication.translate("MainWindow", "sdsdsds", None, -1))
        ...
        self.plainTextEdit_BranchFileInfo.setPlainText(QtWidgets.QApplication.translate("MainWindow", "dfdfd", None, -1))
        ...
        self.label_optionPage_tempB_2.setText(QtWidgets.QApplication.translate("MainWindow", "1st. Root :", None, -1))
        self.lineEdit_setRoot.setText(QtWidgets.QApplication.translate("MainWindow", "//mcd-3d/art_3d_project", None, -1))
        self.label_optionPage_tempB_3.setText(QtWidgets.QApplication.translate("MainWindow", "2nd Root :", None, -1))
        self.lineEdit_setRoot_2.setText(QtWidgets.QApplication.translate("MainWindow", "//mcd-server/art_3d_project", None, -1))
...
######-------------------------------store userPref End-------------------------------------------------------------------        
    ...
    def clickProcessTypeSelectButton(self):
        ...
        self.lineEdit_currentFileName.clear()
    ...
    # datetime.datetime.fromtimestamp(t)
        ...
        if len(self.fullItemIndex) == 1:
            ...
            for file in self.branchFilesInListDict.keys():  # get fileName List in the folder,self.filesStoreBranchFolder
                ...
                if os.path.splitext(checkSingleFileNamePath)[1].split('.')[1] in self.fileTypeFillet:
          ...
          #  print self.filesStoreBranchFolder
           # print "self.branchFilesInListDict.keys()",self.branchFilesInListDict.keys()
            ...
            for file in self.branchFilesInListDict.keys():  # get fileName List in the folder,self.filesStoreBranchFolder
                ...
                if checkSingleFileNamePath.split('.')[-1] in self.fileTypeFillet:
 ...
 #-----------------print out file info in textBrowser function End-------------------------------------------------------------------     
  ...
  #  def getBranchTopFromTreeListB(self): #---------1
    ...
    def createNewBranchCombo(self):
        print'createNewBranchCombo aaaaa'
        
        timeNow = datetime.datetime.now().strftime("%Y%m%d%H%M%S")
        treeItemName = 'newBranch_%s'%timeNow
       # print 'aasdsadsdsad',self.treeWidget_branches.selectedItems(),len(self.treeWidget_branches.selectedItems())
        self.getExistBranchDict()
        
       # print self.topLayerItemDict.keys()
        self.depthLevel= 0

        if len(self.treeWidget_branches.selectedItems()) == 0 :
            print 'create topLayerItem'
            #self.createNewBranchItem(checkTopLayerItemIndex,treeItemName)
            topLayerItemCounnt = self.treeWidget_branches.topLevelItemCount()
            topLayerIremList = []
            for i in range(0,topLayerItemCounnt):
                topLayerIremList.append(self.treeWidget_branches.topLevelItem(i).text(0))
                print topLayerIremList
                    
            if treeItemName in topLayerIremList:
                self.plainTextEdit_BranchFileInfo.clear()
                self.plainTextEdit_BranchFileInfo.setPlainText('wait one second')
                pass
                
            else:
                #checkTopLayerItemIndex = 'none'
                self.createNewBranchItem('none','none',treeItemName)
        

         
        else:
            itemSelect = self.treeWidget_branches.currentItem()
            #checkTopLayerItemIndex = self.treeWidget_branches.indexOfTopLevelItem(self.treeWidget_branches.currentItem())
          #  print itemSelect
            print 'got'
  
            childCount =  itemSelect.childCount()
            childItemList = []
            for i in range(0,childCount):
                childItemList.append(itemSelect.child(i).text(0))
           # print childItemList
                    
            if treeItemName in childItemList:
                self.plainTextEdit_BranchFileInfo.clear()
                self.plainTextEdit_BranchFileInfo.setPlainText('wait one second')
                pass
                ...
                try:
                    self.createNewBranchItem('parent',itemSelect,treeItemName)
                #print 'asdsadsadfffffffff'
                except:
                    pass

            try:
                self.treeWidget_branches.currentItem().setExpanded(1)
            except:
                pass
        ...
        self.pushButton_createNewBranch.setChecked(0)

    def createNewBranchItem(self,parentItem,itemSelect,treeItemName):
       # print itemSelect
        #self.depthLevel = 0
        if parentItem == 'none':
            item = QtWidgets.QTreeWidgetItem(self.treeWidget_branches)
            self.itemNameFlagBrush(item,treeItemName)
            self.treeWidget_branches.setCurrentItem(item) #set selent to new item
            newSelectItem = self.treeWidget_branches.currentItem()
            selectItemFullName = self.workProject+'/'+'scenes'+'/' + treeItemName
        else:
            
            self.checkTreeWidgetBranchesDepth(itemSelect)
         #   print 'self.depthLevel',self.depthLevel
            if self.depthLevel >=3 :
                self.plainTextEdit_BranchFileInfo.clear()
                self.plainTextEdit_BranchFileInfo.setPlainText('3 level depth limitted')
                pass
            else:
            

                item = QtWidgets.QTreeWidgetItem(itemSelect)
                self.itemNameFlagBrush(item,treeItemName)
                self.treeWidget_branches.setCurrentItem(item) #set selent to new item
                newSelectItem = self.treeWidget_branches.currentItem()
        
        
                self.getDepthFullName(newSelectItem)
                selectItemFullName = self.selectItemFullName
        print 'selectItemFullName',selectItemFullName 
        self.createNewFolder(selectItemFullName)
        self.getExistBranchDict()
        
    def itemNameFlagBrush(self,item,treeItemName):
        
                   
        item.setText(0,treeItemName)
        item.setFont(0,self.fontLevelThree)

        #self.treeWidget_branches.setCurrentItem(item)
        ...
        self.pushButton_createNewBranch.setChecked(False)
        
        
        
    def checkTreeWidgetBranchesDepth(self,itemSelect):
        checkTopLayerItemIndex = self.treeWidget_branches.indexOfTopLevelItem(itemSelect)
      #  print 'checkTopLayerItemIndex',checkTopLayerItemIndex
        depthCount = 0
        depthLevel = 0
        ...
        while depthCount <=7:
            ...
            if self.treeWidget_branches.indexOfTopLevelItem(itemSelect) == -1:

                itemSelect = itemSelect.parent()
    ...
    def getDepthFullName(self,itemSelect):
       # print 'getDepthFullName'
        itemName = itemSelect.text(0)
       # print 'self.depthLevel',self.depthLevel
       # print 'parent',itemSelect.parent().text(0)

        self.plainTextEdit_BranchFileInfo.clear()
        self.plainTextEdit_BranchFileInfo.setPlainText('get branch position')
        fullNameList = []
        
        for i in range(0,(self.depthLevel+1)):
          #  print i
           # print itemSelect.parent().text(0)
            itemSelect = itemSelect.parent()
            fullNameList.append(itemSelect.text(0))
                                
       # print 'fullNameList',fullNameList
        
        selectItemFullName = self.workProject+'/'+'scenes'+'/' +'/'.join(reversed(fullNameList)) +'/'+ itemName
        self.selectItemFullName = selectItemFullName 
        print 'selectItemFullName',selectItemFullName 
    ...
    def changeTreeWidget_branchesItemName(self):
        
        #checkTreeWidgetBranchesDepth
        itemSelect =  self.treeWidget_branches.currentItem()
        self.selectItemName = itemSelect.text(0)
       # print 'change change change'
        itemSelect.setFlags(QtCore.Qt.ItemIsSelectable | QtCore.Qt.ItemIsUserCheckable | QtCore.Qt.ItemIsEnabled | QtCore.Qt.ItemIsDragEnabled | QtCore.Qt.ItemIsEditable)
        self.checkTreeWidgetBranchesDepth(itemSelect)
        self.depthLevel = self.depthLevel -1
       # print self.depthLevel
        if self.depthLevel == -1:
            self.selectItemFullName= self.workProject+'/'+'scenes'+'/'+ itemSelect.text(0)
            
        else:
            #print itemSelect.text(0)
            self.getDepthFullName(itemSelect)
        #print self.selectItemFullName
        self.treeWidget_branches.itemChanged.connect(self.itemChangeName)
        '''
        for i in range(0,topLayerItemsCount):
            topLayerItemsList.append(self.treeWidget_branches.topLevelItem(i).text(0))
            print topLayerItemsList
                
        '''
        
    def itemChangeName(self,itemSelect):
        oldName = '/'.join(self.selectItemFullName.split('/')[:-1]) + '/'+ self.selectItemName
        newName = '/'.join(self.selectItemFullName.split('/')[:-1]) + '/'+ itemSelect.text(0)
        
        #print 'asadsd',oldName,newName
        try:
