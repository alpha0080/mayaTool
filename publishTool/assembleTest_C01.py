    ...
    def loadPublishedData(self,assetClass,processType):
       ...
       # file = '//mcd-server/art_3d_project/ani_pop_v01_cf/publish/global/ani_pop_v01_cf_publishAnnonce.json'
        ...
        for i in data['assets'][assetClass].keys():
          ...
          #  print i.split('.')[0]
           # print i
                         # data['assets']['character']['color_owl.character']['rigging']['state']
            try:
              #  print data['assets'][assetClass][i][processType]['state']
         ...
         #   print linkingData
            ...
            #self.itemDict.update({i.split('.')[0]:{linkingData}})
            #self.itemDict[i.split('.')[0]]
            
    
       # self.itemDict = data['assets'][assetType].keys()
        print self.itemDict
