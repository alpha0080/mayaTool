    ...
    def findAssetClassGaveAssetName(self):
       # print 'adasdasdasdasd'
        ...
        if self.isAsset == True:
            ...
            print self.projectAssembleDescription['assets'][self.assetClass][self.assetNow][self.processNow]
        
        else:
            print self.projectAssembleDescription['shot'][self.assetNow][self.processNow]
