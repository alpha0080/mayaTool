...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item.setSizeHint(PySide2.QtCore.QSize(120,60))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tableWidget.horizontalHeaderItem(5).setText(QtWidgets.QApplication.translate("MainWindow", "?°å?æ¬„ä?", None, -1))
        self.tableWidget.horizontalHeaderItem(6).setText(QtWidgets.QApplication.translate("MainWindow", "ex1", None, -1))
        self.tableWidget.horizontalHeaderItem(7).setText(QtWidgets.QApplication.translate("MainWindow", "ex2", None, -1))
