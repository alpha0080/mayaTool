...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon32.addPixmap(QtGui.QPixmap("//Art-1405260002/D/assets/scripts/maya_scripts/icons/publishToolIcon/emoji-32-512C4.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
...
######-------------------------------store userPref End-------------------------------------------------------------------        
    ...
    def checkPublishFileIsExist(self):
       ...
       # print data
        ...
        if self.isAsset == True:
            assetOrShot = 'assets'
            fileName = data['assets'][self.assetClass][tempName][self.processNow]['state']['fileName']
            if os.path.isfile(fileName) == True:
                self.pushButton_gotPublish.setEnabled(True) 
            else:
                self.pushButton_gotPublish.setEnabled(False) 
            #aa['assets']['set']['background_coin.set']['model']['state']['fileName']
        else:
            assetOrShot = 'shot'
            fileName = data['shot'][self.assetNow][self.processNow]['state']['fileName']
            if os.path.isfile(fileName) == True:
                self.pushButton_gotPublish.setEnabled(True) 
            else:
                self.pushButton_gotPublish.setEnabled(False) 
...
################publish Data announce#####################################      
    ...
    def key_pyblishFile(self,publishFileName):
    ...
    def publishMayaFile(self,dest):
        ...
        self.key_pyblishFile(exportMasterFileMB) #store all information to publish_key
