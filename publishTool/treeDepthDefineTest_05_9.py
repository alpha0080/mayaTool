...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #def self.MODDEF(self):
        ...
        self.pushButton_3.clicked.connect(self.itemCountTest)
...
##------------------------------------------------------------------------------------------------------------------------------------------        
        ...
        for i in range(0,totalIteCount):
         ...
         #   print 'eachItemFullDepth',eachItemFullDepth
            ...
            for depth in range(1,eachItemFullDepth):
              ...
              #  print 'start currentCount',currentCount
              ...
              #  print 'delta',delta
                if delta <= 0:
                    ...
                    #self.childItem = parentItem.child(placeIndex)
    ...
    def itemCountTest(self):
        
        print self.treeWidget.topLevelItem(0).childCount()
        
    def noBuildButPass(self,parentItem,placeIndex):
        #self.childItem = parentItem.child()
        self.childItem = parentItem.child(placeIndex)
