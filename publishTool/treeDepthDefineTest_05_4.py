...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def treeBuildPreItem(self,itemDictKeyIndex):
        ...
        rangeCount = len(self.allAssetGrpDepthDict[self.allAssetGrpDepthDict.keys()[itemDictKeyIndex]])
      ...
      #  print 
        ...
        for i in range(0,rangeCount):
            ...
            if i == 0:           #create toplevelItem
               # currentTopLayerItemCount = self.treeWidget.topLevelItemCount  #
                topLayerItemIndex = int(self.allAssetGrpDepthDict[self.allAssetGrpDepthDict.keys()[itemDictKeyIndex]][i])
                ...
                for j in range(0,maxCurrentLevelCount+1):
                    ...
                    print item.text(0)
                  #  topLayerItem = QtWidgets.QTreeWidgetItem(self.treeWidget.topLevelItem(topLayerItemIndex))
                    #return item
