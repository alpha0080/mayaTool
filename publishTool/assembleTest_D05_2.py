...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow ):
    ...
    def __init__(self, parent= QtWidgets.QApplication.activeWindow()):
        ...
        #super(myTree, self).__init__(self.treeWidget_sceneAssembleTree)
      ...
      #  drag = QtGui.QDrag(self)
       ...
       # self.treeWidget_sceneAssembleTree.itemPressed.connect(self.pressTest)
        ...
        self.setFontC()
        pressItem = QtWidgets.QTreeWidgetItem(self.treeWidget_sceneAssembleTree.currentItem())
       # self.tree = QtWidgets.QTreeWidgetItem(self.treeWidget_sceneAssembleTree)
    def mousePressEvent(self, event,pressItem):
        pressItem.mousePressEvent(event)
