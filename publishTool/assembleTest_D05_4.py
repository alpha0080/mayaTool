...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plainTextEdit_assetMetaData.setGeometry(QtCore.QRect(252, 625, 345, 210))
        self.plainTextEdit_assetMetaData.setObjectName("plainTextEdit_assetMetaData")
        self.treeWidget_sceneAssembleTree = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget_sceneAssembleTree.setGeometry(QtCore.QRect(5, 90, 220, 530))
        ...
        self.tableWidget_AssetItemList.setGeometry(QtCore.QRect(252, 90, 345, 530))
        ...
        self.pushButton_P3addItemToLeftA.setGeometry(QtCore.QRect(220, 90, 39, 121))
        ...
        self.pushButton_P3addItemToLeftB.setGeometry(QtCore.QRect(220, 207, 39, 128))
        ...
        self.pushButton_P3addItemToLeftC.setGeometry(QtCore.QRect(220, 327, 39, 128))
        ...
        self.pushButton_P3_addItem.setGeometry(QtCore.QRect(219, 450, 40, 70))
        ...
        self.pushButton_P3_deleteItem.setGeometry(QtCore.QRect(219, 518, 40, 70))
...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #    tree = self.treeWidget_sceneAssembleTree
      ...
      #  drag = QtGui.QDrag(self)
       ...
       # self.pushButton_P3addItemToLeftB.clicked.connect(self.storeOutLineStructure)
        ...
        self.storeOutLineStructure()    # 整理      
        self.runBuildItemLevelTree()    # 整理  itemCollapsed
    ...
    def selectAssetTreeItem(self) : 
        ...
        if  self.treeWidget_sceneAssembleTree.indexOfTopLevelItem(selectItem) == -1:
           ...
           # return selectItemInOutLiner  # get full name from treeWidget select Item
