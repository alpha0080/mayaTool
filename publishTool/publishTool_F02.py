 ...
 #-----------------print out file info in textBrowser function End-------------------------------------------------------------------     
  ...
  #  def getBranchTopFromTreeListB(self): #---------1
    ...
    def createNewBranchCombo(self):
        ...
        print self.treeWidget_branches.indexOfTopLevelItem(self.treeWidget_branches.currentItem())
        '''
        if len(self.treeWidget_branches.currentItem()) == 0:
            print "create topLayer Item"
           # print self.treeWidget_branches.topLevelItemCount()
            #treeItemParent = self.treeWidget_branches
           # item.setText(0,'newBranch')

            #item = QtWidgets.QTreeWidgetItem(selectItem)
            self.createNewBranchItem(-1,treeItemName)
        else:
            ...
            if treeItemName in childItemList:
                ...
                self.createNewBranchItem(itemSelect,treeItemName)
    ...
    def createNewBranchItem(self,treeItemParent,treeItemName):
        if treeItemParent == -1:
            print 'asdadsad'
            
            topLayerItemsCount = self.treeWidget_branches.topLevelItemCount()
            topLayerItemsList = []
            ...
            item = QtWidgets.QTreeWidgetItem(treeItemParent)
