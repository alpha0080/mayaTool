...
######-------------------------------store userPref End-------------------------------------------------------------------        
 ...
 #-----------------print out file info in textBrowser function End-------------------------------------------------------------------     
  ...
  #  def getBranchTopFromTreeListB(self): #---------1
    ...
    def delSelectBranch(self):### 修改方向，先偵測完整的folder結構在複製搬移
       ...
       # print 'fullNameList',fullNameList
        if len(fullNameList) == 0:
            ...
            backupFolder = self.workProject+'/'+'scenes'+'/' +'.backup'+'/'+ itemName
            ...
            print fullNameList
            #resverdFullNameList =  list(reversed(fullNameList))
           # print resverdFullNameList
            for i in range(0,len(fullNameList)):
                print list(reversed(fullNameList))[i]
                print 'backupLevelFolder',backupRootFolder +'/'+list(reversed(fullNameList))[i]
     ...
     #   print 'backupFolder',backupFolder
        self.moveSelectFolderToBackupFolder(selectItemFullName,backupFolder,'copy')
    ...
    def moveSelectFolderToBackupFolder(self,root_src_dir,root_target_dir,operation):
