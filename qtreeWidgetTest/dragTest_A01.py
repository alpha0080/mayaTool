...
#
# Created: Wed Jul 05 22:31:08 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget_2.setAutoScrollMargin(8)
...
class mod_MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #def self.MODDEF(self):
      ...
      # QTreeWidget.setIconSize(QSize(width,height))
       ...
       # self.treeWidget_2.topLevelItem(0).setIconSize(QtCore.QSize(32, 32))
       # icon.setIconSize(QtCore.QSize(32, 32))
       # self.treeWidget_2.topLevelItem(0).setIconSize(1,QtGui.QSize(32, 32))
        self.treeWidget_2.setIconSize(QtCore.QSize(60,60))

        self.treeWidget_2.topLevelItem(0).setIcon(1,icon)
